...
// ============================================================
// PRODUCT PRICES
// Same products as PurchaseEntry.jsx
// ============================================================
...
export default function PurchaseReturn() {
  ...
  const updateItem = (id, field, value) => {
    setItems((prev) =>
      prev.map((item) => {
        ...
        // ------------------------------------------------------
        // PRODUCT CHANGE
        // Automatically set purchase price + GST
        // ------------------------------------------------------
  ...
  const handleSubmit = (e) => {
    ...
    if (!invoiceNo.trim()) {
      alert(
        "Please enter the original purchase invoice number."
      );
      return;
    }
    ...
    // ----------------------------------------------------------
    // CHECK INVENTORY BEFORE MAKING ANY CHANGES
    // ----------------------------------------------------------
    ...
    //
    // Original invoice gets "Returned" status.
    // ==========================================================
    ...
    // UPDATE INVENTORY
    //
    // Purchase return means stock goes DOWN.
    // ==========================================================
    ...
    // SUPPLIER BALANCE
    //
    // Purchase on credit increases balance.
    // Purchase return decreases balance.
    // ==========================================================
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-500/20 dark:bg-amber-500/10">
                ...
                <p className="text-sm text-amber-700 dark:text-amber-300">
                  ...
                  <strong>Note:</strong>{" "}
                  Returned quantity should be verified
