          ...
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-800/60 bg-slate-950/40 py-3 pl-12 pr-4 text-sm text-slate-200 placeholder:text-slate-500 outline-none transition focus:border-emerald-500/40 focus:ring-2 focus:ring-emerald-500/20"
              />
            </div>
            ...
            <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
              ...
              >
                <option className="bg-slate-900 text-slate-200">All</option>
                <option className="bg-slate-900 text-slate-200">Completed</option>
                <option className="bg-slate-900 text-slate-200">Pending</option>
                <option className="bg-slate-900 text-slate-200">Returned</option>
              </select>
            </div>
            ...
            >
              <option className="bg-slate-900 text-slate-200">All</option>
              <option className="bg-slate-900 text-slate-200">Paid</option>
              <option className="bg-slate-900 text-slate-200">Pending</option>
              <option className="bg-slate-900 text-slate-200">Refunded</option>
            </select>
          </div>
        </div>
