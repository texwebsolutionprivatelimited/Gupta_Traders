...
export default function DuePayment() {
  ...
  const handlePayment = (e) => {
    ...
    if (amount > currentDue) {
      alert(
        `Payment cannot be greater than the current due of ${formatCurrency(
          currentDue
        )}.`
      );
      return;
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <button
            type="button"
            onClick={() =>
              navigate("/customers/khata")
            }
            className="rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800"
          >
            Customer Khata
          </button>
                      ...
                      <td className="px-5 py-4">
                        ...
                        <div className="flex justify-center gap-2">
                          ...
                          <button
                            ...
                            className="rounded-lg border border-slate-200 p-2 text-slate-500 transition hover:bg-slate-100 hover:text-emerald-500 dark:border-slate-700 dark:hover:bg-slate-800"
                          >
                            <Eye size={17} />
                          </button>
                ...
                {payments.map((payment) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      ...
                      <span className="inline-flex items-center gap-2 rounded-full bg-blue-500/10 px-3 py-1 text-xs font-semibold text-blue-500">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm">
          ...
          <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="mb-6">
              ...
              <div className="mt-4 rounded-xl bg-rose-500/10 p-4">
            ...
            >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-xl border border-slate-300 bg-white py-3 pl-10 pr-4 outline-none focus:border-emerald-500 dark:border-slate-700 dark:bg-slate-800"
                  />
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-xl border border-slate-300 bg-white px-4 py-3 outline-none focus:border-emerald-500 dark:border-slate-700 dark:bg-slate-800"
                />
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 rounded-xl border border-slate-300 px-4 py-3 text-sm font-semibold transition hover:bg-slate-100 dark:border-slate-700 dark:hover:bg-slate-800"
                >
                  Cancel
                </button>
