...
export default function ManagerAccess() {
  ...
  const managerModules = [
    { label: 'Dashboard', path: '/', desc: 'Business summary', icon: <FaChartPie className="text-emerald-400" />, color: 'border-emerald-500/20 bg-emerald-500/5' },
    ...
    { label: 'Sales', path: '/sales', desc: 'Invoices & records', icon: <FaChartLine className="text-emerald-400" />, color: 'border-emerald-500/20 bg-emerald-500/5' },
    ...
    { label: 'Reports', path: '/reports', desc: 'Store reports', icon: <FaFolderOpen className="text-teal-400" />, color: 'border-teal-500/20 bg-teal-500/5' },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between border-b border-slate-800/40 pb-5">
          <div>
            ...
            <p className="text-slate-400 text-xs mt-0.5">{formattedDate} • Operational Management Access</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          {/* Manager authorized modules checklist */}
          <div className="lg:col-span-2 rounded-2xl border border-slate-800/60 bg-slate-900/60 backdrop-blur-xl p-5">
            <div className="flex items-center gap-3 mb-4.5 border-b border-slate-800/40 pb-3">
              <FaClipboardList className="text-lg text-slate-450" />
              <h3 className="text-base font-bold text-slate-100">Store Modules Directory ({managerModules.length} Modules)</h3>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {managerModules.map((mod) => (
                ...
                >
                  ...
                  <span className="text-xs font-bold text-slate-200 group-hover:text-amber-400 transition-colors">{mod.label}</span>
        ...
        <div className="rounded-2xl border border-slate-800/60 bg-slate-900/60 backdrop-blur-xl overflow-hidden">
          <div className="flex items-center justify-between p-5 border-b border-slate-800/60">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-bold text-slate-100">Recent Sales Records</h3>
            </div>
            <button
