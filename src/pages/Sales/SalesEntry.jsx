                                            ...
                                            <tr key={item.id}>
                                                <td className="px-5 py-4">
                                                    ...
                                                    >
                                                        ...
                                                        <option value="Aashirvaad Atta">Aashirvaad Atta</option>
                                                        <option value="Fortune Rice">Fortune Rice</option>
                                                        <option value="Tata Salt">Tata Salt</option>
                                                        <option value="Amul Milk">Amul Milk</option>
                                                        <option value="Parle-G Biscuit">Parle-G Biscuit</option>
                                                        <option value="Maggi Noodles">Maggi Noodles</option>
                                                        <option value="Fortune Oil">Fortune Oil</option>
                                                ...
                                                <td className="px-5 py-4 font-medium text-slate-50">
                                                    ₹{calculated.amount.toFixed(2)}
                                                </td>

                                                <td className="px-5 py-4 text-slate-50">
