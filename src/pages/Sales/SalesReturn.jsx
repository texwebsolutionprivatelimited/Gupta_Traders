...
/* =========================================================
   ...
   Replace these later with API/database product data.
   ========================================================= */
...
export default function SalesReturn() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Sales Return:", returnData);
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                >
                  ...
                  <option value="Rahul Traders">
                    Rahul Traders
                  </option>

                  <option value="Sharma General Store">
                    Sharma General Store
                  </option>

                  <option value="Amit Enterprises">
                    Amit Enterprises
                  </option>

                  <option value="Gupta Retailers">
                    Gupta Retailers
                  </option>

                  <option value="Verma Supermarket">
                    Verma Supermarket
                  </option>
                      ...
                      <tr key={item.id}>
                        ...
                        <td className="px-5 py-4">
                          ...
                          >
                            ...
                            <option value="Aashirvaad Atta">
                              Aashirvaad Atta
                            </option>

                            <option value="Fortune Rice">
                              Fortune Rice
                            </option>

                            <option value="Tata Salt">
                              Tata Salt
                            </option>

                            <option value="Amul Milk">
                              Amul Milk
                            </option>

                            <option value="Parle-G Biscuit">
                              Parle-G Biscuit
                            </option>
