...
import { addStock, findInventoryProduct } from "../../utils/inventoryStorage";
...
export default function PurchaseEntry() {
  ...
  const updateItem = (id, field, value) => {
    setItems((prev) =>
      prev.map((item) => {
        ...
        // Product select hone par price + GST automatically fill
        if (field === "product") {
          return {
            ...item,
            product: value,
  ...
  const handleSubmit = (e) => {
    ...
    // ==========================================================
    // CHECK ALL PRODUCTS BEFORE UPDATING INVENTORY
    // ==========================================================

    for (const item of items) {
      const existingProduct =
        findInventoryProduct(item.product);
    ...
    // ==========================================================
    // UPDATE COMMON INVENTORY
    //
    // IMPORTANT:
    // inventoryStorage.js ka STORAGE_KEY:
    // "inventoryProducts"
    //
    // Isliye yahan direct "inventory" localStorage use nahi karna.
    // ==========================================================
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <FormField label="Supplier" required>
                ...
                >
                  ...
                  <option value="Hindustan Distributors">
                    Hindustan Distributors
                  </option>

                  <option value="Gupta FMCG Suppliers">
                    Gupta FMCG Suppliers
                  </option>

                  <option value="Shree Grocery Traders">
                    Shree Grocery Traders
                  </option>

                  <option value="Daily Needs Wholesale">
                    Daily Needs Wholesale
                  </option>

                  <option value="Fresh Foods Supply">
                    Fresh Foods Supply
                  </option>
                </select>
              </FormField>
                      ...
                      <tr key={item.id}>
                        ...
                        <td className="px-5 py-4">
                          ...
                          >
                            ...
                            <option value="Moong Dal">
                              Moong Dal
                            </option>

                            <option value="Chana Dal">
                              Chana Dal
                            </option>

                            <option value="Maggi Noodles">
                              Maggi Noodles
                            </option>

                            <option value="Parle-G Biscuits">
                              Parle-G Biscuits
                            </option>

                            <option value="Britannia Good Day">
                              Britannia Good Day
                            </option>
