            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mb-6 grid gap-5 md:grid-cols-3 print:grid-cols-3">
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 print:border-slate-300 print:bg-white">
                        ...
                        <h2 className="mt-2 text-3xl font-bold text-emerald-600 dark:text-emerald-400 print:text-emerald-700">
                            ...
                            <tbody>
                                {customers.map((item) => (
                                    ...
                                    >
                                        ...
                                        <td className="p-4 text-right font-medium text-slate-900 dark:text-slate-100 print:text-black">
                                            {item.totalOrders}
                                        </td>

                                        <td className="p-4 text-right font-semibold text-emerald-600 dark:text-emerald-400 print:text-emerald-700">
